...
class OrganizationModel extends RelationModel {
    ...
    protected $_validate = array(
        array("name", "", "此组织已存在", Model::EXISTS_VAILIDATE, "unique", Model:: MODEL_BOTH),
        array("name", "require", "组织名不能为空", Model::EXISTS_VAILIDATE, "", Model:: MODEL_BOTH), //当用户输入空格是怎么办?只能放在页面验证?
